...
// The SCRIPT_SCHEMA defines the expected structure of the JSON response from the Gemini model.
const SCRIPT_SCHEMA = {
  type: Type.OBJECT,
  properties: {
...
/**
 * Generates a FiveM script using Gemini AI.
 * Follows coding guidelines for @google/genai initialization and usage.
 */
